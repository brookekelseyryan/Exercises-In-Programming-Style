...
#
# Exercise 36.4, Exercises in Programming Style:
# Implement a Neural Network that learns to transform characters into their LEET counterparts.  Use any encoding and any LEET alphabet.
#
